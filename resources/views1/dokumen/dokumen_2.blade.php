                                        ...
                                        <ul class="nav nav-tabs mt-2 pl-3" data-toggle="" id="tabMenu" role="tablist">
                                            @if (Auth::user()->gocap_id_pc_pengurus != null and $hal == 'upzis')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="/{{ $role }}/arsip/dokumen_digital_pc/upzis">Semua
                                                        Arsip</a>
                                                </li>
                                                            ...
                                                            <div class="p-1 bd-highlight">
                                                                <span>
                                                                    @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                                        ...
                                                                        @else
                                                                            Arsip Dokumen Digital yang dibuat
                                                                            oleh
                                                                    ...
                                                                    @elseif(Auth::user()->gocap_id_upzis_pengurus != null)
                                                                        @if ($hal == 'pc')
                                                                            <span class="">Arsip Dokumen Digital Yang
                                                                                Dibuat Oleh <span class="text-bold">PC
                                                                                    LAZISNU CILACAP
                                                                                </span>
                                                                            </span>
                                                                        @else
                                                                            Arsip Dokumen Digital Yang Dibuat Oleh <span
                                                    ...
                                                    {{-- <div class="col-12 col-md-2 col-sm-12 mb-2 mb-xl-0">
                                                        @if ($hal == 'pc')
                                                            <div class="btn-group btn-block mb-2 mb-xl-0"
                                                                style="{{ $display }}">
                                                                <a href="/{{ $role }}/arsip/tambah_dokumen_digital/pc"
                                                        ...
                                                        @elseif($hal == 'upzis')
                                                            <div class="btn-group btn-block mb-2 mb-xl-0"
                                                                style="{{ $display }}">
                                                                <a href="/{{ $role }}/arsip/tambah_dokumen_digital/upzis"
                                                                    class="btn btn-success  btn-block"><i
                                                                        class="fas fa-plus-circle"></i>
                                                                    Tambah</a>
                                                                                    ...
                                                                                    <div class="dropdown-menu">
                                                                                        ...
                                                                                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                                                            @if ($part == 'pc_dokumen')
                                                                                                ...
                                                                                                @if ($dokumen_terim->id_pengguna == Auth::user()->id_pengguna)
                                                                                                    <a onMouseOver="this.style.color='red'"
                                                                                                        style=""
                                                                                                        onMouseOut="this.style.color='black'"
                                                                                                        class="dropdown-item "
