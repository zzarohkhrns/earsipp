            ...
            <form method="post" action="/{{ $role }}/aksi_tambah_surat_masuk" enctype="multipart/form-data">
                ...
                <div class="card card-success ">
                    ...
                    <div class="card-body ">
                        ...
                        {{-- Disposisi --}}
                        <div class="card card-success ijo-atas intro-table-disposisi-sm" id="disposisi-card">
                            <div class="row mt-4 ml-4 justify-content-between">
                                <div>
                                    <br>
                                    ...
                                    &nbsp; <a id="panduan-tambah-disposisi-surat-masuk" class="sweet-tooltip"
                                        data-style-tooltip="tooltip-mini-slick"><i class="far fa-question-circle"></i></a>
                                </div>
                                <!-- Button trigger modal -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-6">
                                        ...
                                        <div class="form-group row intro-perihal-disposisi-sm intro-perihal-disposisi-sm">
                        ...
                        {{-- SPPD --}}
                        <div class="card card-success intro-table-sppds-sm" id="sppd-card">
                            <div class="row mt-4 ml-4 justify-content-between">
                                <div>
                                    <h3 class="card-title "><b>Rincian SPPD</b>
                                    </h3>
                                    &nbsp; <a href="#" class="sweet-tooltip"
                                        data-style-tooltip="tooltip-mini-slick" id="panduan-tambah-sppd-surat-masuk"><i
                        ...
                        <div class="card card-success ijo-atas intro-scan-masuk">
                            <div class="row mt-4 ml-4 justify-content-between">
                                <div>
                                    ...
                                    &nbsp; <a href="#" class="sweet-tooltip"
                                        data-style-tooltip="tooltip-mini-slick" id="panduan-tambah-files-surat-masuk"><i
                                            class="far fa-question-circle"></i></a>
                                </div>
                                ...
                                <div class="col-auto mr-3">
                                    ...
                                    <button id="addRow" type="button"
                                        class="btn btn-primary intro-tambah-lampiran-sm"><i class="fas fa-plus-circle"
                            ...
                            <div class="card-body mr-3 ml-3 intro-scan-sm">
                                ...
                                <div class="form-group row ">
                                    ...
                                    {{-- <input style="width: 100%;" class="form-control"
                                        class="form-control m-input @error('nama_surat') is-invalid @enderror"
                                        value="{{ old('nama_surat') }}" type="text" id="formFileSm"
                                        name="nama_surat" placeholder="Masukan Judul Surat" autocomplete="off"> --}}
                                ...
                                <div class="form-group row ">
                                    <input style="width: 100%;"
                                        ...
                                        name="scan_surat" id="formFileSm" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png"
                                        autocomplete="off">
                                    @error('scan_surat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
