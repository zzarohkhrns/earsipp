                                ...
                                <div class="modal fade" id="staticTambah" data-backdrop="static" data-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <!-- Form Element sizes -->
                                            <form
                                                action="/{{ $role }}/arsip/proses_edit_surat_keluar/{{ $arsip->arsip_digital_id }}"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header ">
                                                        ...
                                                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                            <h5 class="modal-title" id="exampleModalLabel"> Tambah Ketua
                                                                UPZIS Penerima Surat</h5>
                                                        @elseif (Auth::user()->gocap_id_upzis_pengurus != null)
                                                            <h5 class="modal-title" id="exampleModalLabel"> Tambah
                                                                KOORDINATOR RANTING Penerima Surat</h5>
                                                        @endif
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select required
                                                                            class="select2 @error('akses_ketua_upzis') is-invalid @enderror"
                                                                            multiple="multiple"
                                                                            data-placeholder="Pilih Penerima Surat"
                                                                            style="width: 100%;"
                                                                            name="akses_ketua_upzis[]">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($tb_penerima_surat as $tps)
                                                    ...
                                                    <tr>
                                                        ...
                                                        @elseif (Auth::user()->gocap_id_upzis_pengurus != null)
                                                            <td>{{ 'KOORDINATOR RANTING ' . $wilay->nama }}</td>
                                                        @endif
