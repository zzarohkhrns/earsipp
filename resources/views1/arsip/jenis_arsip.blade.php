...
@section('arsip_keluar_ac', 'active')
                        ...
                        <li class="breadcrumb-item active">
                            @if (Auth::user()->gocap_id_pc_pengurus != null)
                                <a href="/{{ $role }}/dashboard">Dashboard</a> / <a
                                    href="/{{ $role }}/arsip/surat_keluar_pc/pc">Surat Keluar</a> /
                                {{ $page }}
                            @elseif (Auth::user()->gocap_id_upzis_pengurus != null)
                                <a href="/{{ $role }}/dashboard">Dashboard</a> / <a
                                    href="/{{ $role }}/arsip/surat_keluar_upzis/upzis">Surat Keluar</a> /
                                {{ $page }}
                            @endif
                        </li>
                    </ol>
    ...
    <div class="modal fade bd-example" id="tambahkategori" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/' . $role . '/aksi_tambah_jenis_surat/') }}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <label style="float: left;">Nama Jenis Surat</label>&nbsp;
                                <sup class="badge badge-danger text-white mb-2"
                                    style="background-color:rgba(230,82,82)">WAJIB</sup>
                                <input type="text" class="form-control" placeholder="" name="jenis" id="jenis"
                                    required>
                            </div>

                            <div class="form-group">

                                <label style="float: left;">Kode Jenis Surat</label>&nbsp;
                                <sup class="badge badge-danger text-white mb-2"
                                    style="background-color:rgba(230,82,82)">WAJIB</sup>
                                <input type="text" class="form-control" placeholder="" name="kode" id="kode"
                                    required>
                            </div>
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card ijo-atas card-table-jenis-surat-keluar">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 ">
                                            <h5>Data Jenis & Kode Surat</h5>
                                            Menampilkan Data Jenis & Kode Surat
                                        </div>
                                        <div class="col-2"></div>
                                        <div class="col-2"></div>
                                        ...
                                        <div class="col-2 col-sm-2 mb-0 ">
                                            <div class="small-box bg-white">
                                                <div class="inner p-2  text-right">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-success btn-block card-tambah-jenis-surat-keluar"
                                            ...
                                            <tbody>
                                                @foreach ($jenis_surat as $jenis)
                                                    <tr>
                                                        ...
                                                        <td>{{ $jenis->jenis }}</td>
                                                        <td>{{ $jenis->kode }}</td>
                                                        <td>{{ \Carbon\Carbon::parse($jenis->created_at)->isoFormat('dddd, D MMMM Y') }}
                                                        </td>
                                                        <td>
                                                            <div class="btn-group   ">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-target="#exampleModals{{ $jenis->kode_jenis_surat_id }}">
                                                                    ...
                                                                    <a onMouseOver="this.style.color='red'" style=""
                                                                        onMouseOut="this.style.color='black'"
                                                                        class="dropdown-item "
                                                                        href="/{{ $role }}/aksi_hapus_jenis_surat/{{ $jenis->kode_jenis_surat_id }}"
                                                    ...
                                                    <div class="modal fade bd-example"
                                                        id="exampleModals{{ $jenis->kode_jenis_surat_id }}"
                                                        ...
                                                        <div class="modal-dialog " role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="/{{ $role }}/aksi_edit_jenis_arsip/{{ $jenis->kode_jenis_surat_id }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
...
@section('js')
    ...
    @push('jenis_kode_surat_keluar')
        <script>
            introJs().setOptions({
                    steps: [{
                            element: document.querySelector('.card-table-jenis-surat-keluar'),
                            title: 'Jenis Arsip Surat Keluar',
                            intro: 'Menampilkan Data Jenis Arsip Surat Keluar yang nantinya akan dipakai pada Tambah Surat Keluar'
                        },
                        {
                            element: document.querySelector('.card-tambah-jenis-surat-keluar'),
                            title: 'Tambah Jenis Arsip Surat Keluar',
                            intro: 'Klik Disini Untuk Melakukan Tambah Jenis Surat Keluar'
                        }
                    ]
