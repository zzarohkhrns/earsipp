                    ...
                    <ol class="breadcrumb m-0 pl-4">
                        <li class="breadcrumb-item active">
                            <a href="/{{ $role }}/dashboard">Dashboard</a> / <a
                                href="/{{ $role }}/arsip/berita">Berita Umum</a> / {{ $page }}
                        </li>
                    </ol>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="modal fade bd-example" id="tambahkategori" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/' . $role . '/aksi_tambah_kategori_berita/') }}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <label style="float: left;">Nama Kategori Berita</label>&nbsp;
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card ijo-atas card-table-kategori-berita-umum">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 ">
                                            <h5>Data Kategori Arsip Berita</h5>
                                            Menampilkan Data Kategori Arsip Berita
                                        </div>
                                        <div class="col-2"></div>
                                        <div class="col-2"></div>
                                        ...
                                        <div class="col-2 col-sm-2 mb-0">
                                            <div class="small-box bg-white">
                                                <div class="inner p-2  text-right card-tambah-kategori-berita-umum">
                                                ...
                                                @foreach ($kategori_berita as $kategori)
                                                    <tr>
                                                            ...
                                                            <div class="btn-group   ">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-target="#exampleModals{{ $kategori->id_kategori_berita }}">
                                                                    ...
                                                                    <a onMouseOver="this.style.color='red'" style=""
                                                                        ...
                                                                        data-toggle="modal"
                                                                        data-target="#modal_hapus{{ $kategori->id_kategori_berita }}"><i
                                                        ...
                                                        <div class="modal fade"
                                                            id="modal_hapus{{ $kategori->id_kategori_berita }}"
                                                            role="dialog" aria-labelledby="exampleModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <form
                                                                        action="/{{ $role }}/aksi_hapus_kategori_berita/{{ $kategori->id_kategori_berita }}"
                                                                        method="post">
                                                                        @csrf
                                                                        <div class="modal-header">
                                                    ...
                                                    <div class="modal fade bd-example"
                                                        id="exampleModals{{ $kategori->id_kategori_berita }}"
                                                        ...
                                                        <div class="modal-dialog " role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="/{{ $role }}/aksi_edit_kategori_berita/{{ $kategori->id_kategori_berita }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-body">
...
@section('js')
    ...
    @push('intro_kategori_berita')
        <script>
            function klikkene(value) {
                introJs().setOptions({
                        steps: [{
                                element: document.querySelector('.card-table-kategori-berita-umum'),
                                title: 'Kategori Berita',
                                intro: 'Menampilkan Data Kategori Berita Yang Nantinya Digunakan Pada Berita Umum '
                            },
                            {
                                element: document.querySelector('.card-tambah-kategori-berita-umum'),
                                title: 'Tambah kategori Berita',
                                intro: 'Klik Disini Untuk Melakukan tambah kategori berita'
                            }
                        ]
