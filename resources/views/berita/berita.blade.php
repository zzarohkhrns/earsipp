                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card ijo-atas">
                                    ...
                                    <div class="col-12  col-md-12 col-sm-12 mb-2 mb-xl-0 mt-2">
                                        <div class="card">
                                                    ...
                                                    <div class="row card-filter-berita">
                                                        ...
                                                        <div class="col-12 col-md-4 col-sm-12 mb-2 mb-xl-0">
                                                            <div class="input-group">
                                                                ...
                                                                <select class="form-control " name="kategori"
                                                                    ...
                                                                    @else
                                                                    <option value="{{ $kategoris }}" selected hidden>
                                                                        {{ $kategoris }}
                                                                    </option>
                                                                    @endif
                                                        ...
                                                        {{-- <div class="col-12 {{ $co }} col-sm-12 mb-2 mb-xl-0">
                                                            <div class="btn-group btn-block mb-2 mb-xl-0">
                                                                <button type="submit" onclick="$('#cover-spin').show(0)"
                                            ...
                                            <div class="form-row mt-2">
                                                ...
                                                {{-- tombol tambah --}}
                                                @if (Auth::user()->PcPengurus->PengurusJabatan->jabatan == 'Divisi IT
                                                dan Media')
                                                <div
                                                    ...
                                                    <div class="dropdown-menu col-12 col-md-12 col-sm-12 mb-2 mb-xl-0">
                                                        ...
                                                        <a onclick="$('#cover-spin').show(0)"
                                                            ...
                                                            onMouseOut="this.style.color='black'" class="dropdown-item "
                                                            href="/{{ $role }}/arsip/kategori_berita" type="button"><i
                                                                class="fas fa-plus-circle"></i>
                                                            Tambah Kategori</a>
                            ...
                            <b>Berita lazisnucilacap.com yang belum tersinkron dengan siftnu</b>
                            <div class="scrollmenu d-flex overflow-auto mb-3">
                                @foreach ($filteredPosts as $post)

                                <div class="card mx-2" style="width: 18rem; border-radius: 10px;">
                                    ...
                                    <div class="card-footer d-flex align-items-center">
                                        <a href="/generate-wordpress-berita/{{ $post['id'] }}"
                                            class="btn btn-{{ $post['status']=='update'?'warning':'success' }}">Generate
                                            {{ $post['status']=='update'?'Ulang':'' }}</a>

                                        <span class="ml-auto">{{ DateTime::createFromFormat('Y-m-d\TH:i:s',
                                            $post['date'])->format('d-M-Y') }}</span>
                                    </div>
                                </div>
                                @endforeach
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><b style="font-size: 16px;">{{
                                                    \Carbon\Carbon::parse($data_berita->tanggal_terbit)->isoFormat('dddd,
                                                    D MMMM Y') }}</b>
                                                <br>
                                            ...
                                            <td>
                                                ...
                                                $hitung = count($arr);
                                                for ($x = 0; $x < $hitung; $x++) {
                                                    echo '<span style="font-size:13px;" class="badge badge-success rounded-pill">'
                                                    . '#' . $arr[$x] . '</span>' . '&nbsp;' ; } @endphp </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @if (Auth::user()->PcPengurus->PengurusJabatan->jabatan ==
                                                        'Divisi IT dan Media')
                                            ...
                                            {{-- modal hapus --}}
                                            <div class="modal fade" id="modal_hapus{{ $data_berita->id_berita_umum }}"
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <sup class="badge badge-danger text-white mb-2"
                                                            style="background-color:rgba(230,82,82)">WAJIB</sup>
                                                        <textarea type="text"
                                                            class="form-control @error('alamat_lembaga_entitas_edit') is-invalid @enderror"
                                                            wire:model.defer="alamat_lembaga_entitas_edit"
                                                            placeholder="Masukan alamat" rows="4"> </textarea>
