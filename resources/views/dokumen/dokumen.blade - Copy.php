                                ...
                                <ul class="nav nav-tabs  mt-2 pl-3" data-toggle="" id="tabMenu" role="tablist">
                                    @if (Auth::user()->gocap_id_pc_pengurus != null and $hal == 'upzis')
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                href="/{{ $role }}/arsip/dokumen_digital_pc2/upzis">Kepada PC
                                                {{ $wilayah }}</a>
                                        </li>
                                    @endif
                                    @if (Auth::user()->gocap_id_upzis_pengurus != null and $hal == 'upzis')
                                        <li class="nav-item"><a class="nav-link active" href="#semua"
                                                data-toggle="tab">Oleh Upzis {{ $wilayah }}</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                href="/{{ $role }}/arsip/dokumen_digital_upzis2/upzis">Kepada
                                                Upzis
                                                {{ $wilayah }}</a>
                                        </li>
                                    @endif
                                                    ...
                                                    <div class="col-12 col-md-12 col-sm-12 mb-2 mb-xl-0">
                                                        <div class="d-flex flex-row bd-highlight align-items-center">
                                                            ...
                                                            <div class="p-1 bd-highlight">
                                                                <span>Menampilkan Dokumen Digital
