                            ...
                            @if (Auth::user()->gocap_id_pc_pengurus != null)
                                @if ($hal == 'pc')
                                    <a href="/{{ $role }}/dashboard">Dashboard</a> / <a
                                        href="/{{ $role }}/arsip/dokumen_digital_pc/pc">Dokumen Digital</a> /
                                    <a>{{ $page }}</a>
                                @elseif($hal == 'upzis')
                                    <a href="/{{ $role }}/dashboard">Dashboard</a> / <a
                                        href="/{{ $role }}/arsip/dokumen_digital_pc/upzis">Dokumen Digital</a> /
                                    <a>{{ $page }}</a>
                                @endif
                            @elseif(Auth::user()->gocap_id_upzis_pengurus != null)
                                @if ($hal == 'pc')
                                    <a href="/{{ $role }}/dashboard">Dashboard</a> / <a
                                        href="/{{ $role }}/arsip/dokumen_digital_upzis/pc">Dokumen Digital</a> /
                                    <a>{{ $page }}</a>
                                @elseif($hal == 'upzis')
                                    <a href="/{{ $role }}/dashboard">Dashboard</a> / <a
                                        href="/{{ $role }}/arsip/dokumen_digital_upzis/upzis">Dokumen Digital</a> /
                                    <a>{{ $page }}</a>
                                @endif
                            @endif
                        </li>
    ...
    <section class="content">
        <div class="container-fluid ">
            ...
            @php
                $rul = strtolower($role);
            @endphp
            <form method="post" action="/{{ $role }}/arsip/aksi_tambah_dokumen_digital"
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body ">
                        <!-- Surat Masuk -->
                        <div class="card card-success ijo-atas intro-table-inp-dc">
                            <div class="row mt-4 ml-4 justify-content-between">
                                <div>
                                    <h3 class="card-title "><b>Rincian Dokumen Digital </b>
                                    </h3>


                                    &nbsp; <a href="#" class="sweet-tooltip" data-style-tooltip="tooltip-mini-slick"
                                        id="panduan-rincian-dokumen-digital-tambah"><i
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-6">
                                        ...
                                        <div class="form-group row intro-tgl-arsip-dc">
                                        ...
                                        <div class="form-group row intro-nama-dokumen-dc">
                                            <label class="col-sm-4 col-form-label">Nama Dokumen</label>
                                            <div class="col-sm-8">
                                                <input type="text"
                                                    class="form-control @error('nama_dokumen') is-invalid @enderror"
                                                    name="nama_dokumen" placeholder="Masukan Nama Dokumen"
                                                    value="{{ old('nama_dokumen') }}" autocomplete="off">
                                                @error('nama_dokumen')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row intro-klasifikasi-dc">
                                            <label class="col-sm-4 col-form-label">Klasifikasi
                                                Dokumen</label>
                                            <div class="col-sm-8">
                                                <select
                                                    class="form-control @error('klasifikasi_dokumen') is-invalid @enderror"
                                                    name="klasifikasi_dokumen"
                                                    data-placeholder="Masukan Klasifikasi Dokumen"
                                                    value="{{ old('klasifikasi_dokumen') }}">
                                                    @if (old('klasifikasi_dokumen'))
                                                        <option value="{{ old('klasifikasi_dokumen') }}" selected hidden>
                                                            {{ old('klasifikasi_dokumen') }}</option>

                                                        @foreach ($jenis_klasifikasi_dokumen as $jenis_klasifikasi_dokumen)
                                                            <option
                                                                value="{{ $jenis_klasifikasi_dokumen->nama_klasifikasi_dokumen }}">
                                                                {{ $jenis_klasifikasi_dokumen->nama_klasifikasi_dokumen }}
                                                            </option>
                                                        @endforeach
                                                    @else
                                                        <option value="" selected hidden>Pilih Klasifikasi Dokumen
                                                        </option>
                                                        @foreach ($jenis_klasifikasi_dokumen as $jenis_klasifikasi_dokumen)
                                                            <option
                                                                value="{{ $jenis_klasifikasi_dokumen->nama_klasifikasi_dokumen }}">
                                                ...
                                                {{-- <select
                                                    ...
                                                    @if (old('klasifikasi_dokumen') == 'Laporan Tahunan')
                                                        <option value="Laporan Tahunan" selected>Laporan Tahunan
                                                        </option>
                                                    ...
                                                    @elseif(old('klasifikasi_dokumen') == 'Produk Hukum Organisasi NU')
                                                        <option value="Laporan Tahunan">Laporan Tahunan
                                                        <option value="Produk Hukum Organisasi NU" selected>Produk Hukum
                                                            Organisasi NU</option>
                                                        </option>
                                                        <option value="Produk Hukum Organisasi Banom">Produk Hukum
                                                            Organisasi Banom</option>
                                                    ...
                                                    @elseif(old('klasifikasi_dokumen') == 'Produk Hukum Organisasi Banom')
                                                        <option value="Laporan Tahunan">Laporan Tahunan
                                                        <option value="Produk Hukum Organisasi NU">Produk Hukum
                                                            Organisasi NU</option>
                                                        </option>
                                                        <option value="Produk Hukum Organisasi Banom" selected>Produk
                                                            Hukum
                                                            Organisasi Banom</option>
                                                        <option value="Hasil Bahtsul Masail">Hasil Bahtsul Masail
                                                        </option>
                                                    @elseif(old('klasifikasi_dokumen') == 'Hasil Bahtsul Masail')
                                                        <option value="Laporan Tahunan">Laporan Tahunan
                                                        <option value="Produk Hukum Organisasi NU">Produk Hukum
                                                            Organisasi NU</option>
                                                        </option>
                                                        <option value="Produk Hukum Organisasi Banom">Produk
                                                            Hukum
                                                            Organisasi Banom</option>
                                                        <option value="Hasil Bahtsul Masail" selected>Hasil Bahtsul
                                                            Masail
                                                        </option>
                                                    @else
                                                        <option value="Laporan Tahunan">Laporan Tahunan
                                        ...
                                        {{-- <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Hak Akses Dokumen</label>
                                            <div class="col-sm-8">
                                                <select class="form-control select2" multiple="multiple"
                                                    data-placeholder="Masukan Hak Akses Arsip" style="width: 100%;"
                                                    name="akses_golongan[]">
                                        ...
                                        <div class="form-group row intro-disposisi-dc">
                                            <label class="col-sm-4 col-form-label">Disposisi</label>
                                    ...
                                    <div class="col-lg-6 col-6">
                                        ...
                                        {{-- <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Sumber Dokumen
                                            </label>
                                            <div class="col-sm-8">
                                                <input type="text"
                                                    class="form-control @error('pengirim_sumber') is-invalid @enderror"
                                                    name="pengirim_sumber" placeholder="Masukan Sumber Dokumen"
                                                    value="PBNU" readonly>
                                        ...
                                        <div class="form-group row intro-pengirim-dc">
                                            <label class="col-sm-4 col-form-label">Pengirim Sumber</label>
                                            <div class="col-sm-8">
                                                @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                    <input type="text"
                                                        class="form-control @error('pengirim_sumber') is-invalid @enderror"
                                                        name="pengirim_sumber" placeholder="Masukan Tujuan Dokumen"
                                        ...
                                        <div class="form-group row intro-deskripsi-dc">
                                            <label class="col-sm-4 col-form-label">Deskripsi Dokumen</label>
                                            <div class="col-sm-8">
                                                <textarea class="form-control  @error('perihal_isi_deskripsi') is-invalid @enderror" name="perihal_isi_deskripsi"
                                                    id="" cols="30" rows="6">{{ old('perihal_isi_deskripsi') }}</textarea>
                        ...
                        {{-- Disposisi --}}
                        <div class="card card-success intro-table-disposisis-dc" id="disposisi-card">
                            <div class="row mt-4 ml-4 justify-content-between">
                                <div>
                                    <br>
                                    ...
                                    &nbsp; <a href="#" class="sweet-tooltip"
                                        ...
                                        id="panduan-tambah-disposisi-dokumen-digital"><i
                                            class="far fa-question-circle"></i></a>
                                </div>
                                <!-- Button trigger modal -->
                                ...
                                {{-- <div class="col-auto mr-3">
                                    <br>
                                    <button type="submit" onclick="previewdisposisi(this.form)" class="btn btn-primary"
                                        name="submit">
                            ...
                            {{-- <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn btn-outline-primary  active intro-select-satuan-dc">
                                                        <input type="radio" name="penerima_satuan"
                                                            id="tombol-jenis-disposisi1" autocomplete="off" checked>
                                                        Satuan
                                                    </label>
                                                    <label class="btn btn-outline-primary intro-select-golongan-dc">
                                                        <input type="radio" name="penerima_golongan"
                                                            id="tombol-jenis-disposisi2" autocomplete="off">
                                                        Golongan
                                                    </label>

                                                    <label class="btn btn-outline-primary intro-select-internal-dc ">
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-6">
                                        <div class="form-group row intro-sifat-disposisi-dc">
                                            <label class="col-sm-4 col-form-label">Sifat</label>

                                            <div class="col-sm-8">

                                                <select class="form-control @error('sifat') is-invalid @enderror"
                                                    name="sifat" data-placeholder="Masukan Klasifikasi Dokumen"
                                        ...
                                        <div class="form-group row intro-sppd-dc">
                                    ...
                                    <div class="col-lg-6 col-6">
                                        ...
                                        <div class="form-group row intro-perihal-disposisi-dc">
                            ...
                            <div class="card-body intro-table-disposisi-dc">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-6 ">
                                        ...
                                        <div class="form-group row intro-sppd-sm intro-sppd-disposisi-dc">
                                            <label class="col-sm-4 col-form-label">SPPD</label>
                                            <div class="col-sm-8">
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    <label class="btn btn-outline-primary  active" id="sppd1actv1">
                                    ...
                                    <div class="col-lg-6 col-6">
                                        ...
                                        <div class="form-group row intro-perihal-disposisi-dc intro-perihal-disposisi-dc">
                                            <label class="col-sm-4 col-form-label">Perihal Disposisi</label>
                                            <div class="col-sm-8">
                                                <input
                                                    class="form-control  @error('perihal_disposisi') is-invalid @enderror"
                        ...
                        {{-- SPPD --}}
                        <div class="card card-success intro-table-sppds-dc" id="sppd-card">
                            <div class="row mt-4 ml-4 justify-content-between">
                                <div>
                                    ...
                                    &nbsp; <a href="#" class="sweet-tooltip"
                                        data-style-tooltip="tooltip-mini-slick"
                                        id="panduan-sppd-tambah-dokumen-digital"><i
                                            class="far fa-question-circle"></i></a>
                                </div>
                                <!-- Button trigger modal -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-6">
                                        ...
                                        <div class="form-group row intro-tgl-perintah-sppd-dc">
                                        ...
                                        <div class="form-group row intro-tgl-pelaksana-sppd-dc">
                                            <label class="col-sm-4 col-form-label">Tgl
                                                Pelaksanaan</label>
                                            <div class="col-sm-8">
                                                <input type="date"
                                    ...
                                    <div class="col-lg-6 col-6">
                                        ...
                                        <div class="form-group row intro-anggaran-sppd-dc">
                                        ...
                                        <div class="form-group row intro-perihal-sppd-dc">
                        ...
                        {{-- Lampiran --}}
                        <div class="card card-success ijo-atas intro-tambahs-lampiran-dc">
                            <div class="row mt-4 ml-4 justify-content-between">
                                <div>
                                    <h3 class="card-title "><b>Upload Lampiran</b>
                                    </h3>
                                    &nbsp; <a href="#" class="sweet-tooltip"
                                        data-style-tooltip="tooltip-mini-slick" id="panduan-tambah-files-dokumen"><i
                                            class="far fa-question-circle"></i></a>
                                </div>

                                <div class="col-auto mr-3 intro-tambah-lampiran-dc">

                                    <button id="addRow" type="button" class="btn btn-primary"><i
                            ...
                            <div class="card-body mr-3 ml-3 intro-scan-dc">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <input style="width: 100%;"
                                        ...
                                        placeholder="Masukan Judul Lampiran Dokumen" autocomplete="off">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <input style="width: 100%;"
                                        ...
                                        class="form-control m-input" type="file" name="scan_surat" id="formFileSm"
                    ...
                    <div class="card-footer ">
                        <div class="col-auto float-right">
                            <!-- Button trigger modal -->
                            <a href=" javascript:history.back()" type="button" class="intro-batal-dc btn btn-secondary">
                                <i class="fas fa-ban"></i> Batal
                            </a>
                            <button onclick="$('#cover-spin').show(0)" type="submit"
                                class="intro-save-dc btn btn-success intro-saves-dc" name="submit">
    ...
    @push('tambah_dokumen')
        {{-- <script>
            function klikkene(value) {
                introJs().setOptions({
                        steps: [{
                                element: document.querySelector('.intro-table-inp-dc'),
                                title: 'Rincian Dokumen Digital',
                                intro: 'Form Input Dokumen Digital'
                            },
                            {
                                element: document.querySelector('.intro-tgl-arsip-dc'),
                                title: 'Tanggal Dokumen',
                                intro: 'Kolom Input Untuk Kapan Surat Ini Dibuat'
                            },
                            {
                                element: document.querySelector('.intro-nama-dokumen-dc'),
                                title: 'Nama Dokumen',
                                intro: 'Kolom Input Untuk Nama Dokumen yang Dibuat'
                            },
                            {
                                element: document.querySelector('.intro-klasifikasi-dc'),
                                title: 'Klasifikasi Dokumen',
                                intro: 'Kolom Input Untuk Klasifikasi Dokumen yang Dibuat'
                            },
                            {
                                element: document.querySelector('.intro-disposisi-dc'),
                                title: 'Disposisi Surat',
                                intro: 'Memunculkan Isian Data Disposisi Surat Yang Dibutuhkan'
                            },
                            {
                                element: document.querySelector('.intro-pengirim-dc'),
                                title: 'Pengirim Sumber',
                                intro: 'Kolom Input Untuk Pengirim Sumber Dibuat'
                            },
                            {
                                element: document.querySelector('.intro-deskripsi-dc'),
                                title: 'Deskripsi Dokumen',
                                intro: 'Kolom Input Untuk Deskripsi Dokumen'
                            },
                            {
                                element: document.querySelector('.intro-tambah-lampiran-dc'),
                                title: 'Tambah Lampiran Lainnya',
                                intro: 'Menampilkan Lampiran Baru Jika Dibutuhkan untuk melakukan Tambah Data Lampiran'
                            },
                            {
                                element: document.querySelector('.intro-scan-dc'),
                                title: 'Scan Surat',
                                intro: 'Kolom Input Untuk isian file dan nama file yang akan disimpan '
                            },
                            {
                                element: document.querySelector('.intro-save-dc'),
                                title: 'Simpan',
                                intro: 'Klik Disini Untuk Menyimpan Data Dokumen'
                            }
                        ]
        ...
        {{-- <script>
            ...
            yes.onclick = function() {
                introJs().setOptions({
                        steps: [{
                                element: document.querySelector('.intro-table-disposisis-dc'),
                                title: 'Disposisi / Tembusan ',
                                intro: 'Menampilkan Data Isian Disposisi Surat'
                            },
                            {
                                element: document.querySelector('.intro-select-satuan-dc'),
                                title: 'Penerima Satuan ',
                                intro: 'Menampilkan Data Satuan Penerima Disposisi Surat'
                            },
                            {
                                element: document.querySelector('.intro-select-golongan-dc'),
                                title: 'Penerima Golongan',
                                intro: 'Menampilkan Data Golongan Penerima Disposisi Surat '
                            },
                            {
                                element: document.querySelector('.intro-select-internal-dc'),
                                title: 'Penerima Intenal',
                                intro: 'Menampilkan Data Internal Pengurus Penerima Disposisi Surat'
                            },
                            {
                                element: document.querySelector('.intro-sifat-disposisi-dc'),
                                title: 'Sifat Disposisi',
                                intro: 'Menunjukan Pilihan Disposisi Surat '
                            },
                            {
                                element: document.querySelector('.intro-perihal-disposisi-dc'),
                                title: 'Perihal Disposisi',
                                intro: 'Kolom Input Untuk perihal Disposisi Surat'
                            },
                            {
                                element: document.querySelector('.intro-sppd-dc'),
                                title: 'SPPD',
        ...
        <script>
            var yeso = document.getElementById("panduan-tambah-disposisi-dokumen-digital");
            yeso.onclick = function() {
                introJs().setOptions({
                    steps: [{
                            element: document.querySelector('.intro-table-disposisi-dc'),
                            title: 'Disposisi',
                            intro: 'Form Disposisi Dokumen Digital '
                        },
                        {
                        ...
                        {
                            element: document.querySelector('.intro-sppd-disposisi-dc'),
                            title: 'SPPD',
        ...
        <script>
            var yeso = document.getElementById("panduan-rincian-dokumen-digital-tambah");
            yeso.onclick = function() {
                introJs().setOptions({
                    steps: [{
                            element: document.querySelector('.intro-table-inp-dc'),
        ...
        <script>
            var yeso = document.getElementById("panduan-sppd-tambah-dokumen-digital");
            yeso.onclick = function() {
                introJs().setOptions({
                    steps: [{
                            element: document.querySelector('.intro-table-sppds-dc'),
                            title: 'SPPD',
                            intro: 'Form Input SPPD Dokumen Digital'
                        },
                        {
                            element: document.querySelector('.intro-tgl-perintah-sppd-dc'),
                            title: 'Tanggal Perintah',
                            intro: 'Masukkan Tanggal Perintah SPPD Pada Kolom Ini'
                        },
                        {
                            element: document.querySelector('.intro-tgl-pelaksana-sppd-dc'),
                            title: 'Anggaran ',
                            intro: 'Masukkan Anggaran SPPD Pada Kolom Ini'
                        },
                        {
                            element: document.querySelector('.intro-anggaran-sppd-dc'),
                            title: 'Tanggal Pelaksanaan',
                            intro: 'Masukkan Tanggal Pelaksanaan SPPD Pada Kolom Ini'
                        },
                        {
                            element: document.querySelector('.intro-perihal-sppd-dc'),
                            title: 'Perihal ',
        ...
        <script>
            var yeso = document.getElementById("panduan-tambah-files-dokumen");
            yeso.onclick = function() {
                introJs().setOptions({
                    steps: [{
                            element: document.querySelector('.intro-tambahs-lampiran-dc'),
                            title: 'Lampiran Dokumen',
                            intro: 'Form Tambah Lampiran Dokumen'
                        },
                        {
                            element: document.querySelector('.intro-tambah-lampiran-dc'),
                            title: 'Tambah Lampiran Lainnya',
                        ...
                        {
                            element: document.querySelector('.intro-batal-dc'),
                            title: 'Batal',
                            intro: 'Klik Disini Untuk Membatalkan Penyimpanan Arsip Dokumen'
                        },
                        {
                            element: document.querySelector('.intro-saves-dc'),
                            title: 'Simpan',
                            intro: 'Klik Disini Untuk Menyimpan Arsip Dokumen'
                        }
                    ]
                }).start();
            }
