                                ...
                                <div class="card-body ">
                                            ...
                                            <ul class="nav nav-tabs mt-2 pl-3" data-toggle="" id="tabMenu" role="tablist">
                                                @if (Auth::user()->gocap_id_pc_pengurus != null and $hal == 'upzis')
                                                    ...
                                                    <li class="nav-item"><a class="nav-link"
                                                            href="/{{ $role }}/arsip/surat_masuk_pc2/upzis">Arsip
                                                            Yang
                                                ...
                                                @if (Auth::user()->gocap_id_upzis_pengurus != null and $hal == 'upzis')
                                                    ...
                                                    <li class="nav-item"><a class="nav-link"
                                                            href="/{{ $role }}/arsip/surat_masuk_upzis2/upzis">
                                                            Arsip Yang
                                            ...
                                            <div class="card ">
                                                <div class="card-body ">
                                                    ...
                                                    <form method="post"
                                                        ...
                                                        <input type="hidden" name="filephp" value="surat_masuk">


                                                        <div class="row card-filter-surat_masuk">
                                                        ...
                                                        <div class="form-row mt-2">
                                                                    ...
                                                                    <div class="p-1 bd-highlight">
                                                                        <span>
                                                                            @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                                                ...
                                                                                @else
                                                                                    Arsip Surat Masuk yang ditujukan &
                                                                                    dibuat
                                                                                    oleh
                                                                                ...
                                                                                @if ($hal == 'pc')
                                                                                    <span class="">Arsip Surat Masuk
                                                                                        ...
                                                                                        Ditujukan kepada <span
                                                                                            class="text-bold">PC
                                                                                            LAZISNU CILACAP
                                                                                        </span> & Didisposisikan Kepada Anda
                                                                                    </span>
                                                                                @else
                                                                                    <span class="">Arsip Surat Masuk
                                                                                        Yang
                                                                                        Dibuat & Ditujukan kepada <span
                                                                                            class="text-bold">UPZIS MWC NU
                                                                                            {{ $wilayah }}
                                                                                        </span>
                                                                                    </span>
                                                                                @endif
                                                            ...
                                                            <div class="col-12 col-md-2 col-sm-12 mb-2 mb-xl-0 ">
                                                                @if ($hal == 'pc')
                                                                    <div class="btn-group btn-block mb-2 mb-xl-0 card-tambah-surat_masuk"
                                                                        style=" {{ $display }}">
                                                                        <div class="btn-group  mb-2 mb-xl-0 btn-block">
                                                                            <a onclick="$('#cover-spin').show(0)"
                                                                                href="/{{ $role }}/arsip/tambah_surat_masuk/pc"
                                                                ...
                                                                @elseif($hal == 'upzis')
                                                                    <div class="btn-group btn-block mb-2 mb-xl-0 card-tambah-surat_masuk"
                                                                        ...
                                                                        <div class="btn-group  mb-2 mb-xl-0 btn-block">
                                                                            <a onclick="$('#cover-spin').show(0)"
                                                                                href="/{{ $role }}/arsip/tambah_surat_masuk/upzis"
                                                                                class="btn btn-success  btn-block"><i
                                                                                    class="fas fa-plus-circle"></i>
                                                                                Tambah</a>
                                                                        </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="semua">
                                            ...
                                            <section class="content">
                                                <div class="container-fluid">
                                                    <div class="row card-table-surat-masuk">
                                                        <div class="col-12">
                                                            ...
                                                            <table id="example3" class="table table-bordered "
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>Klasifikasi</th>
                                                                        <th style="width: 200px;">Perihal & Pokok Isi</th>
                                                                        <!-- Lebar lebih besar -->
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($arsip_dikirim as $arsip_dikir)
                                                                        <tr>
                                                                            @php
                                                                                $jumlah_internal = DB::table(
                                                                                    'arsip_digital',
                                                                                )
                                                                                    ->join(
                                                                                        'disposisi',
                                                                                        'arsip_digital.arsip_digital_id',
                                                                                        '=',
                                                                                        'disposisi.arsip_digital_id',
                                                                                    )
                                                                                    ->where(
                                                                                        'disposisi.arsip_digital_id',
                                                                                        $arsip_dikir->arsip_digital_id,
                                                                                    )
                                                                                    ->where(
                                                                                        'arsip_digital.jenis_disposisi',
                                                                                        'Internal',
                                                                                    )
                                                                                    ->count();

                                                                                $jumlah_satuan = DB::table(
                                                                                    'arsip_digital',
                                                                                )
                                                                                    ->join(
                                                                                        'disposisi',
                                                                            ...
                                                                            <td>
                                                                                <strong style="font-size: inherit;">
                                                                                    {{ \Carbon\Carbon::parse($arsip_dikir->created_at)->translatedFormat('d-m-Y') }}
                                                                                </strong>
                                                                                <br>
                                                                                {{ App\Http\Controllers\ArsipDigitalController::nama_pengurus_pc($arsip_dikir->diinput_oleh) }}
                                                                            </td>
                                                                            <td>
                                                                                <strong style="font-size: inherit;">
                                                                            ...
                                                                            <td>
                                                                                <strong style="font-size: inherit;">
                                                                                    {{ \Carbon\Carbon::parse($arsip_dikir->tanggal_arsip)->translatedFormat('d-m-Y') }}
                                                                                </strong>
                                                                                <br> {{ $arsip_dikir->nomor_surat }}
                                                                            </td>
                                                                            ...
                                                                            <td style="width:100px;">
                                                                                ...
                                                                                <strong style="font-size: inherit;">
                                                                                    {{ $arsip_dikir->perihal_isi_deskripsi }}
                                                                                    <br>
                                                                                </strong>
                                                                                {{ $arsip_dikir->keterangan_surat_masuk }}

                                                                                {{-- <strong
                                                                                    style="font-size: inherit;">{{ Str::limit($arsip_dikir->keterangan_surat_masuk, 80) }}...
                                                                                </strong> --}}
                                                                            </td>
                                                                            {{-- <td>proses</td> --}}

                                                                            @if ($arsip_dikir->sifat == 'Segera')
                                                                                <td>
                                                                                    <span style="font-size:14px;"
                                                                                        class="badge rounded-pill bg-success">
                                                                                        Segera
                                                                            ...
                                                                            @elseif($arsip_dikir->sifat == 'Sangat Segera')
                                                                                <td>
                                                                                    <span style="font-size:14px;"
                                                                                        class="badge rounded-pill bg-primary">
                                                                                        Sangat Segera
                                                                            ...
                                                                            @elseif($arsip_dikir->sifat == 'Rahasia')
                                                                                <td>
                                                                                    <span style="font-size:14px;"
                                                                                        class="badge rounded-pill bg-danger">
                                                                                        Rahasia
                                                                                    </span><br> {{ $arsip_dikir->perihal }}
                                                                                    {{ $arsip_dikir->perihal }}
                                                                                </td>
                                                                            @else
                                                                                <td>Tidak ada disposisi</td>
                                                                            @endif
                                                                                ...
                                                                                <div class="modal fade"
                                                                                    ...
                                                                                    <div class="modal-dialog"
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            <form
                                                                                                action="/{{ $role }}/arsip/hapus_surat_masuk/{{ $arsip_dikir->arsip_digital_id }}"
                                                                                                method="post">
                                                                                                @csrf
        ...
        @if ($display == '')
            <script>
                function klikkene(value) {
                    introJs().setOptions({
                            steps: [{
                                    element: document.querySelector('.card-surat-masuk'),
                                    title: 'Surat Masuk',
                                    intro: 'Surat Masuk dapat dibuat oleh siapa saja dan dapat diubah oleh pembuat serta akan ditujukan kepada semua pengurus pada Wilayah tersebut'
                                },
                                {
                                    element: document.querySelector('.card-filter-surat_masuk'),
                                    title: 'Filter Surat Masuk',
                                    intro: 'Untuk menampilkan arsip surat masuk secara spesifik, gunakan filter data'
                                },
                                {
                                    element: document.querySelector('.card-tambah-surat_masuk'),
                                    title: 'Tambah Surat Masuk',
                                    intro: 'Klik disini untuk membuat surat masuk baru'
                                },
                                {
                                    element: document.querySelector('.card-table-surat-masuk'),
                                    title: 'Data Arsip Surat Masuk',
                                    intro: 'Menampilkan Data Surat Masuk'
                                }
                            ]
