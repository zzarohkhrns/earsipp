...
<body>
    ...
    <header>
        <center>
            <img style="width: 40%; height:70px;" src="{{ public_path('/images/satuan_logo.png') }}"><br><br>
            <b>
                LEMBAGA AMIL ZAKAT INFAQ SHODAQOH NAHDLATUL ULAMA CILACAP <br>
                UNIT PENGELOLA ZAKAT INFAQ SHODAQOH <br>
                MAJELIS WAKIL CABANG NAHDLATUL ULAMA <br>
                KECAMATAN {{ strtoupper($nama_wilayah->nama) }} <br>
            </b>
            <br>
        </center>
        <p style="padding-left: 20px;"><b>Pembuat Surat: {{ $pembuat->nama }}</b></p>
        <center>
            <img style="width: 99%; height:5px;" src="{{ public_path('/images/line.png') }}">
        </center>
    </header>
    ...
    <main>
        ...
        <p style="margin-bottom:0pt; text-align:center; line-height:normal;"><strong><span
                    style="font-family:Cambria; text-transform:uppercase;">UNIT PENGELOLA ZAKAT INFAQ DAN
                    SHODAQOH</span></strong></p>
        <p style="margin-bottom:0pt; text-align:center; line-height:normal;"><strong><span
                    style="font-family:Cambria; text-transform:uppercase;">LEMBAGA AMIL ZAKAT INFAQ DAN SHODAQOH
                    NAHDLATUL ULAMA&nbsp;</span></strong></p>
        <p style="margin-bottom:0pt; text-align:center; line-height:normal;"><strong><span
                    style="font-family:Cambria; text-transform:uppercase;">MAJELIS WAKIL CABANG NAHDLATUL
                    ULAMA KECAMATAN {{ strtoupper($nama_wilayah->nama) }}</span></strong>
        </p>
        <br>
        <table style="margin-bottom:0pt;">
            <tbody>
        ...
        {{-- <div>
            <br><br>
            <p style="margin-bottom:0pt; line-height:normal; font-size:12pt; font-family:Cambria;">Tembusan :</p>
            <p style="margin-bottom:0pt; line-height:normal; font-size:12pt; font-family:Cambria;">Disampaikan Kepada
                Yth:</p>
            <ol>
                ...
                @foreach ($tb_penerima_surat as $i)
                    @php
                        $rantingz = DB::connection('gocap')
                            ...
                            ->where('id_ranting_pengurus', $i->id_pengurus)
                            ->first();
                        ...
                        $nama_p = DB::connection('siftnu')
                            ->table('pengguna')
                            ->where('gocap_id_ranting_pengurus', $i->id_pengurus)
                            ->first();
                    @endphp

                    <p style="margin-bottom:0pt; line-height:normal; font-size:12pt; font-family:Cambria;">
                        {{ $loop->iteration . '. ' }}{{ 'Kordinator Ranting ' . $wilay->nama }}</p>
                @endforeach
            @endif
        </div> --}}
                    ...
                    @foreach ($tb_penerima_surat as $i)
                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                            ...
                            @if ($i->tujuan == 'Koordinator PLPK')
                                ...
                                <p style="margin-bottom:0pt; line-height:normal; font-size:12pt; font-family:Cambria;">
                                    {{ $loop->iteration . '. ' }}{{ 'Koordinator Ranting ' . $wilay->nama }}</p>
                            @else
                                <p style="margin-bottom:0pt; line-height:normal; font-size:12pt; font-family:Cambria;">
                                    {{ $loop->iteration . '. ' }}{{ $i->penerima_lainnya }}</p>
                            @endif
