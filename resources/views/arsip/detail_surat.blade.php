                                                    ...
                                                    <div class="form-row mt-4">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea class="form-control @error('alamat_pengirim') is-invalid @enderror" name="alamat_pengirim"
                                                                placeholder="Masukan Aalamat Pengirim">{{ $arsip->alamat_pengirim }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea class="form-control @error('keterangan_surat_masuk') is-invalid @enderror" name="keterangan_surat_masuk"
                                                                placeholder="Masukan Keterangan">{{ $arsip->keterangan_surat_masuk }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-6">
                                    ...
                                    <div class="form-group row intro-keterangan-sm">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="keterangan_surat_masuk" disabled>{{ $arsip->keterangan_surat_masuk ?? '-' }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-6">
                                    ...
                                    <div class="form-group row intro-alamat-sm">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="alamat_pengirim" disabled>{{ $arsip->alamat_pengirim ?? '-' }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="active tab-pane intro-table-disposisiz-sm" id="disposisi">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-sm-8">
                                                                            ...
                                                                            @foreach ($baca_internal as $baca_internal)
                                                                                @php
                                                                                    $jabatans = DB::connection('gocap')
                                                                                        ...
                                                                                        ->where(
                                                                                            'id_pengurus_jabatan',
                                                                                            $baca_internal->id_pengurus_jabatan,
                                                                                        )
                                                                                        ->select('jabatan')
                                                                                        ->get();
                                                                                @endphp
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <a class="btn btn-success"
                                                                href="/{{ $role }}/arsip/print_disposisi_surat_masuk/{{ $arsip_digital_id }}"
                                                ...
                                                <div class="col-lg-6 col-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-4 col-form-label">Catatan Disposisi</label>
                                                        <div class="col-sm-8">
                                                            @if ($disposisi->catatan_disposisi == null)
                                                            <div class="col-form-label mx-auto">
                                                                -
                                                            </div>
                                                            @else
                                                                <ol style="padding-left:0pt;">
                                                                    @php
                                                                        $kets = array_map(
                                                                            'trim',
                                                                            preg_split(
