                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group intro-penerima-disposisi-out ">
                                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                                            ...
                                            <select class="select2 @error('akses_penerima_surat') is-invalid @enderror"
                                                multiple="multiple" data-placeholder="Pilih Penerima Surat"
                                                style="width: 100%;" name="akses_penerima_surat[]">
                                                ...
                                                @foreach ($ketua_upzis as $ketua_upzis2)
                                                    ...
                                                    {{-- <option value="{{ $ketua_upzis2->id_upzis_pengurus }}"
                                                    {{ in_array($ketua_upzis2->id_upzis, old('akses_penerima_surat') ?: []) ? 'selected' : '' }}>
                                                    {{ 'Ketua Upzis ' . $wily->nama }}
                                                </option> --}}
                                                    </option>
                                                @endforeach
