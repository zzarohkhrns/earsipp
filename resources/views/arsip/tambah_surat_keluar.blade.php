                        ...
                        <div class="card-body ">
                            ...
                            <div class="card card-success ijo-atas intro-table-rincian-arsip-out">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-6">
                                            ...
                                            <div class="form-group row intro-alamat-sm">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control @error('alamat_pengirim') is-invalid @enderror" name="alamat_pengirim"
                                                        placeholder="Masukan alamat pengirim">{{ old('alamat_pengirim') }}</textarea>
                                        ...
                                        <div class="col-lg-6 col-6">
                                                ...
                                                <div class="col-sm-8">
                                                    @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                        <select id="options"
                                                            ...
                                                            onchange="handleChange(this)" name="tujuan_arsip">
                                                            <option value="" hidden selected>Pilih Penerima Surat
                                                            </option>
                                                            <option value="Ketua UPZIS MWCNU">Ketua UPZIS MWCNU </option>
                                                            <option value="Ketua PCNU Cilacap">Ketua PCNU Cilacap
                                                            </option>
                                                            <option value="Koordinator PLPK se Cilacap"> Koordinator PLPK
                                                                se Cilacap
                                                            </option>
                                                            <option value="Kepala Kantor PCNU Cilacap">Kepala Kantor PCNU
                                                                Cilacap
                                                            </option>
                                                    ...
                                                    @else
                                                        ...
                                                        <select id="pilihan"
                                                            class="form-control @error('tujuan_arsip') is-invalid @enderror"
                                                            onchange="handleChanges(this)" name="tujuan_arsip">
                                                            <option value="" hidden selected>Pilih Penerima Surat
                                                            </option>
                                                            <option value="Koordinator PLPK"> Koordinator PLPK
                                                            </option>
                                                            <option value="Lainnya">Lainnya</option>
                                                        </select>
                                                    @endif
                                            ...
                                            @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                <div class="hidden" id="subOptionsLainnya">
                                                    <div class="form-group row intro-perihal-out">
                                                        <label class="col-sm-4 col-form-label">Tujuan Lainnya</label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control" name="tujuan_lainnya"
                                                                placeholder="Masukan Tujuan Lainnya">
                                                        </div>
                                                    </div>
                                                </div>
                                            @elseif (Auth::user()->gocap_id_upzis_pengurus != null)
                                                <div class="hidden" id="subPilihanLainnya">
                                                    <div class="form-group row intro-perihal-out">
                                                        <label class="col-sm-4 col-form-label">Tujuan Lainnya</label>
                                                        <div class="col-sm-8">
                                                            <input class="form-control" name="tujuan_lainnya"
                                                ...
                                                <div class="col-sm-8">
                                                    @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                        <input type="text"
                                                            ...
                                                            name="diinput_oleh" value="{{ Auth::user()->nama }}"
                                                            readonly>
                                                    @elseif (Auth::user()->gocap_id_upzis_pengurus != null)
                                                        <input type="text"
                                                            class="form-control @error('diinput_oleh') is-invalid @enderror"
                                                            name="diinput_oleh" value="Upzis {{ $wilayah }}"
                                                            readonly>
                                                    @endif
                                            ...
                                            <div class="form-group row intro-keterangan-sm">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control @error('keterangan_surat_masuk') is-invalid @enderror" name="keterangan_surat_masuk"
                                                        placeholder="Masukan keterangan">{{ old('keterangan_surat_masuk') }}</textarea>
                                    ...
                                    <span id="selectedValue" class="d-none"></span>
                                    <input type="hidden" id="selectedValueInput" value="" name="js_tujuan">


                                    <div class="form-group intro-penerima-disposisi-out">
                                        @if (Auth::user()->gocap_id_pc_pengurus != null)
                                            {{-- subOptionsA --}}
                                            <div class="hidden" id="subOptionsA">
                                                <label> Penerima Surat </label>
                                                <select
                                                    class="form-control select2 @error('akses_penerima_surat') is-invalid @enderror"
                                                    multiple="multiple" data-placeholder="Pilih Penerima Surat"
                                                    style="width: 100%;" name="akses_penerima_surat[]">
                                            ...
                                            {{-- subOptionsB --}}
                                            <div class="hidden" id="subOptionsB">
                                                <label>Penerima Surat </label>
                                                <div class="input-group">
                                                    <input type="text"
                                                        class="tagsinput form-control  @error('akses_penerima_surat') is-invalid @enderror"
                                                        data-role="tagsinput" placeholder="Masukkan Penerima Surat"
                                            ...
                                            {{-- subOptionsC --}}
                                            <div class="hidden" id="subOptionsC">
                                                <label> Penerima Surat </label>
                                                <select
                                                    class="form-control select2 @error('akses_penerima_surat') is-invalid @enderror"
                                                    multiple="multiple" data-placeholder="Pilih Penerima Surat"
                                                    ...
                                                    @foreach ($koordinator_plpk as $koordinator_plpk2)
                                                        ...
                                                        @endphp
                                                        @if ($wily && $nem)
                                                            <option value="{{ $koordinator_plpk2->id_ranting_pengurus }}"
                                            ...
                                            {{-- subOptionsD --}}
                                            <div class="hidden" id="subOptionsD">
                                                <label>Penerima Surat </label>
                                                <div class="input-group">
                                                    <input type="text"
                                                        class="tagsinput form-control  @error('akses_penerima_surat') is-invalid @enderror"
                                            ...
                                            {{-- subOptionsE --}}
                                            <div class="hidden" id="subOptionsE">
                                                <label>Penerima Surat </label>
                                                <div class="input-group">
                                                    <input type="text"
                                                        class="tagsinput form-control  @error('akses_penerima_surat') is-invalid @enderror"
                                        ...
                                        @else
                                            <div class="hidden" id="subPilihanA">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($koordinator_ranting as $koordinator)
                                                        ...
                                                        {{-- <option value="{{ $koordinator->id_ranting_pengurus }}"
                                                {{ in_array($koordinator->id_upzis, old('akses_penerima_surat') ?: []) ? 'selected' : '' }}>
                                            ...
                                            {{-- subOptionsB --}}
                                            <div class="hidden" id="subPilihanB">
                                                <label>Penerima Surat </label>
                                                <div class="input-group">
                                                    <input type="text"
                                                        class="tagsinput form-control  @error('akses_penerima_surat') is-invalid @enderror"
...
@push('autofill_penerima_surat')
    <script>
        function handleChange(select) {
            var selectedOption = select.value;
            var subOptionsA = document.getElementById('subOptionsA');
            var subOptionsB = document.getElementById('subOptionsB');
            var subOptionsC = document.getElementById('subOptionsC');
            var subOptionsD = document.getElementById('subOptionsD');
            var subOptionsE = document.getElementById('subOptionsE');
            var subOptionsLainnya = document.getElementById('subOptionsLainnya');


            document.getElementById('selectedValue').textContent = selectedOption;
            document.getElementById('selectedValueInput').value = selectedOption;

            if (selectedOption === 'Ketua UPZIS MWCNU') {
                subOptionsA.classList.remove('hidden');
                subOptionsB.classList.add('hidden');
                subOptionsC.classList.add('hidden');
                subOptionsD.classList.add('hidden');
                subOptionsE.classList.add('hidden');
                subOptionsLainnya.classList.add('hidden');


                subOptionsB.querySelector('select').value = '';
                subOptionsC.querySelector('select').value = '';
                subOptionsD.querySelector('select').value = '';
                subOptionsE.querySelector('input').value = '';
                subOptionsLainnya.querySelector('input').value = '';


            } else if (selectedOption === 'Ketua PCNU Cilacap') {
                subOptionsA.classList.add('hidden');
                subOptionsB.classList.remove('hidden');
                subOptionsC.classList.add('hidden');
                subOptionsD.classList.add('hidden');
                subOptionsE.classList.add('hidden');
                subOptionsLainnya.classList.add('hidden');
                ...
                subOptionsA.querySelector('select').value = '';
                subOptionsC.querySelector('select').value = '';
                subOptionsD.querySelector('select').value = '';
                subOptionsE.querySelector('input').value = '';
                subOptionsLainnya.querySelector('input').value = '';
            ...
            } else if (selectedOption === 'Koordinator PLPK se Cilacap') {
                subOptionsA.classList.add('hidden');
                subOptionsB.classList.add('hidden');
                subOptionsC.classList.remove('hidden');
                subOptionsD.classList.add('hidden');
                subOptionsE.classList.add('hidden');
                subOptionsLainnya.classList.add('hidden');
            ...
            } else if (selectedOption === 'Kepala Kantor PCNU Cilacap') {
                subOptionsA.classList.add('hidden');
                subOptionsB.classList.add('hidden');
                subOptionsC.classList.add('hidden');
                subOptionsD.classList.remove('hidden');
                subOptionsE.classList.add('hidden');
                subOptionsLainnya.classList.add('hidden');
            ...
            } else if (selectedOption === 'Lainnya') {
                subOptionsA.classList.add('hidden');
                subOptionsB.classList.add('hidden');
                subOptionsC.classList.add('hidden');
                subOptionsD.classList.add('hidden');
                subOptionsE.classList.remove('hidden');
                subOptionsLainnya.classList.remove('hidden');
                ...
                subOptionsC.querySelector('select').value = '';
                subOptionsD.querySelector('select').value = '';
                subOptionsE.querySelector('select').value = '';
                subOptionsLainnya.querySelector('input').value = '';
    ...
    <script>
        function handleChanges(select) {
            var selectedPilihan = select.value;
            var subPilihansA = document.getElementById('subPilihanA');
            var subPilihansB = document.getElementById('subPilihanB');
            var subPilihansLainnya = document.getElementById('subPilihanLainnya');

            document.getElementById('selectedValue').textContent = selectedPilihan;
            document.getElementById('selectedValueInput').value = selectedPilihan;

            if (selectedPilihan === 'Koordinator PLPK') {
                subPilihansA.classList.remove('hidden');
                subPilihansB.classList.add('hidden');
                subPilihansLainnya.classList.add('hidden');
            } else if (selectedPilihan === 'Lainnya') {
                subPilihansA.classList.add('hidden');
                subPilihansB.classList.remove('hidden');
                subPilihansLainnya.classList.remove('hidden');
            } else {
                subPilihansA.classList.add('hidden');
                subPilihansB.classList.add('hidden');
                subPilihansLainnya.classList.add('hidden');
