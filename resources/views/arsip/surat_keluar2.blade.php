                                        ...
                                        <ul class="nav nav-tabs mt-2 pl-3" data-toggle="" id="tabMenu" role="tablist">
                                            @if (Auth::user()->gocap_id_pc_pengurus != null and $hal == 'upzis')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="/{{ $role }}/arsip/surat_keluar_pc/upzis">Semua
                                                        Arsip</a>
                                                </li>
                                            ...
                                            @if (Auth::user()->gocap_id_upzis_pengurus != null and $hal == 'upzis')
                                                <li class="nav-item"><a class="nav-link"
                                                        href="/{{ $role }}/arsip/surat_keluar_upzis/upzis">Arsip
                                                        Yang Anda Buat</a>
                                                </li>
                                                <li class="nav-item"><a class="nav-link active" href="#">Arsip Yang
                                                        Didisposisikan Kepada Anda</a>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post"
                                                ...
                                                <input type="hidden" name="filephp" value="surat_keluar2">
                                                        ...
                                                        <div class="d-flex flex-row bd-highlight align-items-center">
                                                            ...
                                                            <div class="p-1 bd-highlight">
                                                                <span>
                                                                    @if (Auth::user()->gocap_id_pc_pengurus != null)
                                                                        @if ($hal == 'pc')
                                                                            <span class="">Arsip Surat Keluar Yang
                                                                                Dibuat Oleh <span class="text-bold">PC
                                                                                    LAZISNU CILACAP
                                                                                </span>
                                                                            </span>
                                                                        @else
                                                                            Arsip Surat Keluar Yang Dibuat Oleh <span
                                                                                class="text-bold"> UPZIS MWC NU </span> &
                                                                                    ...
                                                                                    <div class="dropdown-menu">
                                                                                        ...
                                                                                        @if ($arsip_dikir->id_pengguna == Auth::user()->id_pengguna)
                                                                                            <a style="{{ $hide }}"
                                                                                                ...
                                                                                                onMouseOut="this.style.color='black'"
                                                                                                class="dropdown-item "
                                                                                                href="/{{ $role }}/arsip/hapus_surat_keluar/{{ $arsip_dikir->arsip_digital_id }}"
                                                                                                type="button"><i
                                                                                ...
                                                                                <div class="btn-group">
                                                                                    ...
                                                                                    <div class="dropdown-menu">
                                                                                        ...
                                                                                        {{-- <a onMouseOver="this.style.color='red'"
                                                                                            onMouseOut="this.style.color='black'"
                                                                                            class="dropdown-item"
                                                                                            href="/{{ $role }}/arsip/detail_surat_keluar/{{ $arsip_terim->arsip_digital_id }}"
                                                                                            type="button"><i
                                                                                                class="far fa-eye"></i>
                                                                                            Detail</a> --}}
                                                                                        ...
                                                                                        {{-- <a onMouseOver="this.style.color='red'"
                                                                                            ...
                                                                                            onMouseOut="this.style.color='black'"
                                                                                            class="dropdown-item "
                                                                                            href="/{{ $role }}/arsip/hapus_surat_keluar/{{ $arsip_terim->arsip_digital_id }}"
                                                                                            type="button"><i
                                                                                                class="fas fa-trash"></i>
                                                                                            Hapus</a> --}}
