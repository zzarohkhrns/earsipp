...
@section('perorangan', 'active')
@section('penerima_manfaat_ac', 'active menu-open')
@section('penerima_manfaat_mo', 'menu-open')
...
@section('content')
            ...
            <div class="card ijo-atas">
                <div class="p-3   rounded vekap">
                    <div class="container-fluid py-3 ">
                        <div class="row">
                            <div class="col">
                                <h3 class=" fw-bold ">Penerima Manfaat</h3>
                                <p class="">Untuk penerima manfaat LAZISNU CILACAP, silahkan
    ...
    <section class="content ">
        <div class="container-fluid">
            {{-- livewire permohonan --}}
            <livewire:penerima-index></livewire:penerima-index>
        </div>
    </section>
