...
class KeluarMasukAset extends Model
{
    ...
    protected $fillable = ['id_keluar_masuk_aset', 'tanggal_pencatatan', 'id_pencatat', 'id_supervisor', 'id_kc', 'status_pencatatan', 'status_spv', 'status_kc', 'catatan_spv', 'catatan_kc', 'tgl_mengetahui_spv', 'tgl_mengetahui_kc', 'masuk_no_transaksi', 'masuk_tgl_masuk', 'masuk_nama_pemasok', 'masuk_no_faktur', 'masuk_keterangan', 'keluar_no_transaksi', 'keluar_tgl_keluar', 'keluar_nama_pemasok', 'keluar_no_faktur', 'keluar_keterangan'];
