...
class FilterSuratKeluarController extends Controller
{
    ...
    public function filter_surat_keluar(Request $request, $part, $hal)
    {
        ...
        if ($request->filephp == 'surat_keluar') {
            return view('arsip.surat_keluar', compact('bulans', 'disposisis', 'arsip_diterima', 'arsip_dikirim', 'head', 'hal', 'page', 'title', 'klasifikasis', 'tahun', 'tahuns', 'part'));
        } else {
            return view('arsip.surat_keluar2', compact('bulans', 'disposisis', 'arsip_diterima', 'arsip_dikirim', 'head', 'hal', 'page', 'title', 'klasifikasis', 'tahun', 'tahuns', 'part'));
        }
    }
}
