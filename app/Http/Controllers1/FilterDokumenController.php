...
class FilterDokumenController extends Controller
{
    ...
    public function filter_dokumen(Request $request, $part, $hal)
    {
            ...
            if (Auth::user()->gocap_id_pc_pengurus != null) {
                ...
                $dokumen_dikirim = DB::table('arsip_digital')
                    ...
                    ->when($this->klasifikasi, function ($query) {
                        return $query->where('arsip_digital.klasifikasi_dokumen', $this->klasifikasi);
                    })
        ...
        if ($request->filephp == 'dokumen') {
            return view('dokumen.dokumen', compact('bulans', 'disposisis', 'dokumen_diterima', 'dokumen_dikirim', 'head', 'hal', 'page', 'title', 'klasifikasis', 'tahun', 'tahuns', 'part'));
        } else {
            return view('dokumen.dokumen_2', compact('bulans', 'disposisis', 'dokumen_diterima', 'dokumen_dikirim', 'head', 'hal', 'page', 'title', 'klasifikasis', 'tahun', 'tahuns', 'part'));
        }
    }
}
